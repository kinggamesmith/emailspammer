...
me = 'essexvictor7@gmail.com' # change to your email
p_reader = open('marshmallowfridge', 'rb') # edit for your password
cipher = p_reader.read()
recipients = ['washingtonsilver4@gmail.com'] # enter recipients here
